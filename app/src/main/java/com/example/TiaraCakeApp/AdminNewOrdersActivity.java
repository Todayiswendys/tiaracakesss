...
import com.example.TiaraCakeApp.Model.AdminOrders;
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final AdminOrders model) {
                        ...
                        holder.userPhoneNumber.setText("Nama: "+model.getPhone());
                        holder.userTotalPrice.setText("Jumlah total = Rp."+model.getTotalAmount());
                        holder.userDateTime.setText("Pesan di: "+model.getDate()+" "+ model.getTime());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Sudahkah Anda mengirimkan produk pesanan ini?");
